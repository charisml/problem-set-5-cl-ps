...
merged_district_df = districts.merge(enforcement_by_month, how ="left", left_on = "District", right_on = "Judicial District")
merged_district_df.plot(column="num_enforcements", legend = True).set_axis_off()
```
