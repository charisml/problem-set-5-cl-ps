    ...
    while start_date <= today: 
        ...
        for date in dates:
            try:
                ...
                updated_dates.append("Invalid date")

        filtered_dates = updated_dates[4:]
...
df = get_enforcement_actions(2024, 11)
len(df)
...
print(f"I got back {length} enforcement actions in the dataframe. The earliest enforcement action is ____.")
```
...
file_path = "/Users/charismalambert/Documents/GitHub/problem-set-5-cl-ps/output.xlsx"
...
e_by_month_chart.save("enforcements_by_month.html")
```
...
file_path = "/Users/charismalambert/Documents/GitHub/problem-set-5-cl-ps/output.xlsx"
result_df_2021 = pd.read_excel(file_path)
result_df_2021["District"] = result_df_2021["Agency"].str.extract(r"(District of *)")
result_df_2021["District"] = result_df_2021["District"].str.strip()

district_path = "/Users/charismalambert/Documents/GitHub/problem-set-5-cl-ps"
districts = pd.read_csv("districtpath")
merged_district_df = districts.merge(result_df_2021, how ="left", left_on = "District", right_on = "Judicial District")
