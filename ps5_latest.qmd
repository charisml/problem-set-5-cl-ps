...
# Encoding "Category_New" as State Enforcement Agencies and Criminal and Civil Actions
result_df_2021['Category_New'] = np.where(result_df_2021['Category'] == 'State Enforcement Agencies', 
...
line_chart = alt.Chart(count_2021_category).mark_line(point=True).encode(
...
topics = { 'Health Care Fraud': ['health', 'care', 'fraud'], 'Financial Fraud': ['financial', 'bank', 'scam'], 'Drug Enforcement': ['drug', 'enforcement', 'raid'], 'Bribery/Corruption': ['bribery', 'corruption', 'charges'], 'Other': [] } 
...
df_2021_state_mask = result_df_2021['Category_New'] != "Criminal and Civil Actions"
...
combined_df_2021 = pd.concat([df_2021_civil, df_2021_state], ignore_index= True)
